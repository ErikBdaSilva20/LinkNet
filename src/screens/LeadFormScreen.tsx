...
export default function LeadFormScreen() {
  ...
  useEffect(() => {
    if (page) {
      setLeadFormEnabled(page.lead_form_enabled || false);
      setLeadFormTitle(page.lead_form_title || "Fique por dentro");
      setLeadFormDescription(page.lead_form_description || "Cadastre seu e-mail para receber novidades");
      setLeadFormFields(parseFormFields(page.lead_form_fields));
    }
  }, [page]);
