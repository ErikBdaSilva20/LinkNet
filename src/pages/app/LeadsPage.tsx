...
export default function LeadsPage() {
  ...
  const customFieldKeys = useMemo(() => {
    ...
    leads.forEach((lead) => {
      const cf = (lead as typeof lead & { custom_fields?: Record<string, string> }).custom_fields;
          ...
          {leads.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <Table>
                ...
                <TableBody>
                  {leads.map((lead) => {
                    const customFields = (lead as typeof lead & { custom_fields?: Record<string, string> }).custom_fields;
                    return (
                      <TableRow 
                        key={lead.id} 
                      ...
                      >
                        ...
                        <TableCell className="text-foreground">
                          {(lead as typeof lead & { phone?: string }).phone ? (
                            <div className="flex items-center gap-2">
